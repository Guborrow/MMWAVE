...
byteBufferLength = 0
configFileName = 'IWR6843AOP_cfg_IS.cfg'  # Configuration File
gl_numVirtAnt = 3 * 4
AoA_spacing = 1
# endregion
...
def serialConfig(configFileName):
    ...
    CLIport = serial.Serial('/dev/tty.usbmodem000000001', 115200)
    Dataport = serial.Serial('/dev/tty.usbmodem000000004', 921600)
